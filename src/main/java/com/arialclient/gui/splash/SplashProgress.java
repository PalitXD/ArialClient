package com.arialclient.gui.splash;
...
public class SplashProgress {
    ...
    public static void drawSplash(TextureManager tm) {
        ...
        if(SPLASH == null) {
            SPLASH = new ResourceLocation("arialclient/splash.png");
        }
    ...
    private static void drawProgress() {
        ...
        if (unicodeFontRenderer == null) unicodeFontRenderer = UnicodeFontRenderer.getFontOnPC("Arial", 20, Font.PLAIN, 0, 10);
        ...
        unicodeFontRenderer.drawString(CURRENT, 20, sr.getScaledHeight() - 25, -1);

        String step = PROGRESS + "/" + MAX;
        unicodeFontRenderer.drawString(step, sr.getScaledWidth() - 20 - unicodeFontRenderer.getWidth(step), sr.getScaledHeight() - 25, 0xE1E1E1FF);

        GlStateManager.resetColor();
        resetTextureState();
        Gui.drawRect(0, (int)sr.getScaledHeight() - 2, (int)calc, sr.getScaledHeight(), new Color(149, 201, 144).getRGB());
