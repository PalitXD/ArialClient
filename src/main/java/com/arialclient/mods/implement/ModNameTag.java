...
import com.arialclient.utils.Perspective;
...
//        String displayTag = (entity.getDisplayName().getFormattedText());
            ...
            //mc.getTextureManager().bindTexture(new ResourceLocation(new StringBuilder ( ).append (Client.class).append ("/logo.png").toString ( )));
            int b = 9;
    ...
    public static void render(double x, double y, double z)
    {
        ...
        {
            Score score = scoreboard.getValueFromObjective(mc.thePlayer.getName(), scoreobjective);
